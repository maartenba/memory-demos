...
namespace TripDownMemoryLane.Demo03.NewtonsoftJson;
    ...
    : IDemo
{
    public void Run(string[] args)
    {
        ...
        Console.WriteLine("* Compare two snapshots: high traffic on string items");
        Console.WriteLine("* (Lots of string allocations - original file stream, JSON.NET)");
    }
}